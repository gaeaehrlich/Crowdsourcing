...
class Address(models.Model):
    city = models.ForeignKey('City', related_name='%(class)s', on_delete=models.PROTECT, blank=True, null=True)
    street = models.ForeignKey('Street', related_name='%(class)s', on_delete=models.PROTECT, blank=True, null=True)
...
class Review(models.Model):
    ...
    dish = models.ForeignKey(Dish, related_name='reviews', on_delete=models.PROTECT)
